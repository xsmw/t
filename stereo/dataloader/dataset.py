...
class dataset_sceneflow(dataset_stereo):
    ...
    def __init__(self, root):
        ...
        self.flag_img_disp_left = ['frames_cleanpass', 'disparity']
...
class dataset_fly3d_train(dataset_sceneflow):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        flag = 'frames_cleanpass/t/*/left/*.png'
...
class dataset_fly3d_test(dataset_sceneflow):
    ...
    def __init__(self, root):
        ...
        # get_paths_all
        flag = 'frames_cleanpass/t1/*/left/*.png'
        self.str_filter = os.path.join(root, flag)
        self.get_paths_all(self.str_filter, flag_sort=False)
...
def datasets_dict():
    datasets = []  # 需要测试的所有数据集
    root_data = 'C:/Users/59976/Desktop/代码/渐进细化的立体匹配算法/MBFnet-master/t/kitti/'
